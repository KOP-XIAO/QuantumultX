...
function get_emoji(emojip, sname) {
  var Lmoji = { 
    ...
    "🇧🇹": ["Bhutan","不丹"],
    "🇧🇴": ["Bolivia","玻利维亚"],
    "🇧🇦": ["Bosnia and Herzegovina","波斯尼亚和黑塞哥维纳","波黑","波黑共和国"],
    "🇧🇼": ["Botswana","博茨瓦纳"],
    "🇧🇻": ["Bouvet Island","布韦岛","布威岛"],
    "🇧🇷": ["Brazil","巴西"],
    ...
    "🇰🇾": ["Cayman Islands","开曼群岛"],
    "🇨🇫": ["Central African Republic","中非","中非共和国"],
    "🇹🇩": ["Chad","乍得"],
    "🇨🇱": ["Chile","智利"],
    "🇨🇳": ["China","中国"],
    "🇨🇽": ["Christmas Island","圣诞岛"],
    "🇨🇨": ["Cocos Islands","Keeling Islands","科科斯群岛","基林群岛"],
    "🇨🇴": ["Colombia","哥伦比亚"],
    "🇰🇲": ["Comoros","科摩罗群岛","科摩罗"],
    "🇨🇬": ["Republic of the Congo","刚果共和国","刚果(布)","布拉柴维尔"],
    "🇨🇩": ["Democratic Republic of the Congo","DR Congo","刚果民主共和国","刚果(金)","金沙萨"],
    "🇨🇰": ["Cook Islands","库克群岛"],
    "🇨🇷": ["Costa Rica","哥斯达黎加"],
    "🇨🇮": ["Côte d'Ivoire","Ivory Coast","科特迪瓦","象牙海岸"],
    "🇭🇷": ["Croatia","克罗地亚"],
    "🇨🇺": ["Cuba","古巴"],
    "🇨🇼": ["Curaçao","Curacao","库拉索"],
    "🇨🇾": ["Cyprus","塞浦路斯"],
    ...
    "🇩🇰": ["Denmark","丹麦"],
    "🇩🇯": ["Djibouti","吉布提"],
    "🇩🇲": ["Dominica","The Commonwealth of Dominica","多米尼克","多米尼克国"],
    "🇩🇴": ["Dominican Republic","La República Dominicana","多米尼加","多米尼加共和国"],
    "🇪🇨": ["Ecuador","厄瓜多尔"],
    "🇪🇬": ["Eygpt","埃及"],
    "🇪🇺": ["EU","欧盟","欧洲联盟","欧罗巴"],
    "🇸🇻": ["The Salvador","Salvador","萨尔瓦多"],
    "🇬🇶": ["Equatorial Guinea","赤道几内亚"],
    "🇪🇷": ["Eritrea","厄立特里亚"],
    "🇪🇪": ["Estonia","爱沙尼亚"],
    "🇸🇿": ["Eswatini","Swaziland","Kingdom of Eswatini","斯威士兰","斯威士兰王国","史瓦帝尼"],
    "🇪🇹": ["Ethiopia","埃塞俄比亚"],
    ...
    "🇹🇫": ["French Southern and Antarctic Lands","TAAF","法属南部和南极领地","法属南部领地"],
    "🇬🇦": ["Gabon","加蓬"],
    "🇬🇲": ["Gambia","冈比亚"],
    "🇬🇪": ["Georgia","格鲁吉亚"],
    "🇩🇪": ["Germany","Deutschland","德国","法兰克福","京德","滬德","廣德","沪德","广德"],
    "🇬🇭": ["Ghana","加纳"],
    "🇬🇮": ["Gibraltar","直布罗陀"],
    "🇬🇷": ["Greece","希腊"],
    "🇬🇱": ["Greenland","格陵兰岛","格陵兰"],
    ...
    "🇬🇾": ["Guyana","圭亚那"],
    "🇭🇹": ["Haiti","海地"],
    "🇭🇲": ["Heard Island and McDonald Islands","HIMI","赫德岛和麦克唐纳群岛"],
    "🇭🇳": ["Honduras","洪都拉斯"],
    "🇭🇰": ["Hong Kong","香港"],
    "🇭🇺": ["Hungary","匈牙利"],
    "🇮🇸": ["Iceland","冰岛"],
    ...
    "🇰🇪": ["Kenya","肯尼亚"],
    "🇰🇮": ["Kiribati","基里巴斯"],
    "🇰🇵": ["North Korea","朝鲜","北朝鲜","北韩"],
    "🇰🇷": ["South Korea","韩国","南朝鲜","南韩"],
    "🇽🇰": ["Kosovo","科索沃"],
    "🇰🇼": ["Kuwait","科威特"],
    "🇰🇬": ["Kyrgyzstan","吉尔吉斯斯坦","吉尔吉斯"],
    "🇱🇦": ["Laos","老挝","寮国"],
    "🇱🇻": ["Latvia","拉脱维亚"],
    "🇱🇧": ["Lebanon","黎巴嫩"],
    "🇱🇸": ["Lesotho","莱索托"],
    ...
    "🇾🇹": ["Mayotte","马约特"],
    "🇲🇽": ["Mexico","墨西哥"],
    "🇫🇲": ["Micronesia","密克罗尼西亚","密克罗尼西亚联邦"],
    "🇲🇩": ["Moldova","摩尔多瓦"],
    "🇲🇨": ["Monaco","摩纳哥"],
    "🇲🇳": ["Mongolia","蒙古","蒙古国"],
    "🇲🇪": ["Montenegro","蒙特内哥罗","黑山","黑山共和国"],
    "🇲🇸": ["Montserrat","蒙特塞拉特"],
    "🇲🇦": ["Morocco","摩洛哥"],
    "🇲🇿": ["Mozambique","莫桑比克"],
    "🇲🇲": ["Myanmar","缅甸"],
    ...
    "🇳🇨": ["New Caledonia","Nouvelle-Calédonie","新喀里多尼亚"],
    "🇳🇿": ["New Zealand","新西兰"],
    "🇳🇮": ["Nicaragua","尼加拉瓜"],
    "🇳🇪": ["Niger","尼日尔"],
    "🇳🇬": ["Nigeria","尼日利亚"],
    "🇳🇺": ["Niue","纽埃"],
    "🇳🇫": ["Norfolk Island","诺福克群岛"],
    "🇲🇰": ["North Macedonia","北马其顿","马其顿"],
    "🇲🇵": ["Northern Mariana Islands","北马里亚纳","北马里亚纳群岛"],
    "🇳🇴": ["Norway","挪威"],
    "🇴🇲": ["Oman","阿曼"],
    "🇵🇰": ["Pakistan","巴基斯坦"],
    "🇵🇼": ["Palau","帕劳"],
    ...
    "🇵🇪": ["Peru","秘鲁"],
    "🇵🇭": ["Philippines","菲律宾"],
    "🇵🇳": ["Pitcairn Islands","皮特凯恩群岛","皮特凯恩"],
    "🇵🇱": ["Poland","波兰"],
    "🇵🇹": ["Portugal","葡萄牙"],
    "🇵🇷": ["Puerto Rico","波多黎各","波多黎各自由邦"],
    "🇶🇦": ["Qatar","卡塔尔"],
    "🇷🇪": ["Réunion","Reunion","留尼汪"],
    "🇷🇴": ["Romania","罗马尼亚"],
    "🇷🇺": ["Russia","俄罗斯","俄国"],
    "🇷🇼": ["Rwanda","卢旺达"],
    "🇧🇱": ["Saint Barthélemy","Saint Barth","Saint-Barthélemy","圣巴特","圣巴泰勒米"],
    "🇸🇭": ["Saint Helena, Ascension and Tristan da Cunha","圣赫勒拿、阿森松和特里斯坦-达库尼亚"],
    "🇰🇳": ["Saint Kitts and Nevis","圣基茨和尼维斯"],
    "🇱🇨": ["Saint Lucia","圣卢西亚"],
    "🇲🇫": ["Saint Martin","法属圣马丁"],
    "🇵🇲": ["Saint Pierre and Miquelon","圣皮埃尔和密克隆群岛","圣皮埃尔和密克隆","圣皮埃尔"],
    "🇻🇨": ["Saint Vincent and the Grenadines","圣文森特和格林纳丁斯","圣文森特"],
    "🇼🇸": ["Samoa","萨摩亚"],
    "🇸🇲": ["San Marino","圣马力诺"],
    "🇸🇹": ["São Tomé and Príncipe","圣多美和普林西比","圣普"],
    ...
    "🇻🇪": ["Venezuela","委内瑞拉"],
    "🇻🇳": ["Vietnam","越南"],
    "🇻🇬": ["British Virgin Islands","英属维尔京群岛","英属维尔京"],
    "🇻🇮": ["United States Virgin Islands","美属维尔京群岛","美属维尔京"],
    "🇼🇫": ["Wallis and Futuna","瓦利斯和富图纳群岛","瓦利斯和富图纳"],
    "🇪🇭": ["Western Sahara","西撒哈拉"],
    "🇾🇪": ["Yemen","也门"],
    "🇿🇲": ["Zambia","赞比亚"],
    "🇿🇼": ["Zimbabwe","津巴布韦"],
