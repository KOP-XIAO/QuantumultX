/** 
☑️ 资源解析器 ©𝐒𝐡𝐚𝐰𝐧  ⟦2022-06-01 10:28⟧
----------------------------------------------------------
...
function get_emoji(emojip, sname) {
  var Lmoji = { 
    ...
    "🇭🇳": ["Honduras","HN","洪都拉斯"],
    "🇭🇰": ["Hong Kong","HK","香港","深港", "沪港", "HKT", "HKBN", "HGC", "WTT", "CMI", "穗港", "京港", "港"],
    "🇭🇺": ["Hungary","HU","匈牙利"],
    "🇮🇸": ["Iceland","IS","冰岛"],
    "🇮🇳": ["India","IN","印度"],
    "🇮🇩": ["Indonesia","ID","印度尼西亚","印尼"],
    "🇮🇷": ["Iran","IR","伊朗"],
    "🇮🇶": ["Iraq","IQ","伊拉克"],
    "🇮🇪": ["Ireland","IE","爱尔兰"],
    ...
    "🇰🇪": ["Kenya","KE","肯尼亚"],
    "🇰🇮": ["Kiribati","KI","基里巴斯"],
    "🇰🇵": ["North Korea","KP","朝鲜","北朝鲜","北韩"],
    "🇰🇷": ["South Korea","KR","韩国","南朝鲜","南韩"],
    "🇽🇰": ["Kosovo","XK","科索沃"],
    "🇰🇼": ["Kuwait","KW","科威特"],
    ...
    "🇶🇦": ["Qatar","QA","卡塔尔"],
    "🇷🇪": ["Réunion","Reunion","RE","留尼汪"],
    "🇷🇴": ["Romania","RO","罗马尼亚"],
    "🇷🇺": ["Russia","RU","俄罗斯","俄国","京俄", "杭俄","廣俄","滬俄","广俄","沪俄"],
    "🇷🇼": ["Rwanda","RW","卢旺达"],
    ...
    "🇸🇦": ["Saudi Arabia","SA","沙特阿拉伯","沙特"],
    "🇸🇳": ["Senegal","SN","塞内加尔"],
    "🇷🇸": ["Serbia","RS","塞尔维亚"],
    "🇸🇨": ["Seychelles","SC","塞舌尔"],
    "🇸🇱": ["Sierra Leone","SL","塞拉利昂"],
    "🇸🇬": ["Singapore","SG","新加坡", "狮城", "沪新", "京新", "泉新", "穗新", "深新", "杭新", "广新","廣新","滬新"],
    ...
    "🇨🇭": ["Switzerland","CH","瑞士"],
    "🇸🇾": ["Syria","SY","叙利亚"],
    "🇹🇼": ["Taiwan","TW","台湾","台北", "台中", "新北", "彰化", "CHT", "台", "HINET"],
    ...
    "🇺🇬": ["Uganda","UG","乌干达"],
    "🇺🇦": ["Ukraine","UA","乌克兰"],
    "🇦🇪": ["United Arab Emirates","AE","阿拉伯联合酋长国","阿联酋"],
    "🇬🇧": ["United Kingdom","GB","UK","英国"],
    "🇺🇸": ["United States","US","美国"],
