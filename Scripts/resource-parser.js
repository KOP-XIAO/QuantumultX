/** 
☑️ 资源解析器 ©𝐒𝐡𝐚𝐰𝐧  ⟦2022-06-02 08:30⟧
----------------------------------------------------------
...
function get_emoji(emojip, sname) {
  var Lmoji = { 
    ...
    "🇦🇲": ["Armenia","AM","亚美尼亚"],
    "🇦🇼": ["Aruba","AW","阿鲁巴"],
    "🇦🇺": ["Australia","AU", "Sydney", "澳大利亚", "澳洲", "墨尔本", "悉尼" ,"土澳", "京澳","廣澳","滬澳","沪澳","广澳"],
    "🇦🇹": ["Austria","AT","奥地利","维也纳"],
    "🇦🇿": ["Azerbaijan","AZ","阿塞拜疆"],
    "🇧🇸": ["Bahamas","BS","巴哈马"],
    "🇧🇭": ["Bahrain","BH","巴林"],
    "🇧🇩": ["Bangladesh","BD","孟加拉国","孟加拉"],
    "🇧🇧": ["Barbados","BB","巴巴多斯"],
    "🇧🇾": ["Belarus","BY","白俄罗斯"],
    "🇧🇪": ["Belgium","BE","比利时"],
    "🇧🇿": ["Beliz","BZ","伯利兹"],
    ...
    "🇧🇹": ["Bhutan","BT","不丹"],
    "🇧🇴": ["Bolivia","BO","玻利维亚"],
    "🇧🇦": ["Bosnia and Herzegovina","BA","波斯尼亚和黑塞哥维纳","波黑","波黑共和国"],
    "🇧🇼": ["Botswana","BW","博茨瓦纳"],
    "🇧🇻": ["Bouvet Island","BV","布韦岛","布威岛"],
    "🇧🇷": ["Brazil","BRA","巴西"],
    "🇮🇴": ["British Indian Ocean Territory","IO","英属印度洋领地"],
    "🇧🇳": ["Brunei","BN","文莱"],
    "🇧🇬": ["Bulgaria","BG","保加利亚"],
    "🇧🇫": ["Burkina Faso","BF","布基纳法索"],
    "🇧🇮": ["Burundi","BI","布隆迪"],
    "🇰🇭": ["Cambodia","KH","柬埔寨"],
    "🇨🇦": ["Canada","CA","加拿大", "CAN", "Waterloo","蒙特利尔", "温哥华", "楓葉", "枫叶","滑铁卢","多伦多"],
    "🇨🇻": ["Cape Verde","CV","佛得角"],
    "🇧🇶": ["Caribbean Netherlands","BQ","荷属加勒比"],
    "🇰🇾": ["Cayman Islands","KY","开曼群岛"],
    "🇨🇫": ["Central African Republic","CF","中非","中非共和国"],
    "🇹🇩": ["Chad","TD","乍得"],
    "🇨🇱": ["Chile","CL","智利"],
    "🇨🇽": ["Christmas Island","CX","圣诞岛"],
    "🇨🇨": ["Cocos Islands","Keeling Islands","CC","科科斯群岛","基林群岛"],
    "🇨🇴": ["Colombia","CO","哥伦比亚"],
    "🇰🇲": ["Comoros","KM","科摩罗群岛","科摩罗"],
    "🇨🇬": ["Republic of the Congo","CG","刚果共和国","刚果(布)","布拉柴维尔"],
    "🇨🇩": ["Democratic Republic of the Congo","DR Congo","CD","刚果民主共和国","刚果(金)","金沙萨"],
    "🇨🇰": ["Cook Islands","CK","库克群岛"],
    "🇨🇷": ["Costa Rica","CR","哥斯达黎加"],
    "🇨🇮": ["Côte d'Ivoire","Ivory Coast","CI","科特迪瓦","象牙海岸"],
    "🇭🇷": ["Croatia","HR","克罗地亚"],
    "🇨🇺": ["Cuba","CU","古巴"],
    "🇨🇼": ["Curaçao","Curacao","CW","库拉索"],
    "🇨🇾": ["Cyprus","CY","塞浦路斯"],
    "🇨🇿": ["Czechia","CZ","捷克"],
    "🇩🇰": ["Denmark","DNK","丹麦"],
    "🇩🇯": ["Djibouti","DJ","吉布提"],
    "🇩🇲": ["Dominica","The Commonwealth of Dominica","DM","多米尼克","多米尼克国"],
    "🇩🇴": ["Dominican Republic","La República Dominicana","DO","多米尼加","多米尼加共和国"],
    "🇪🇨": ["Ecuador","EC","厄瓜多尔"],
    "🇪🇬": ["Eygpt","EG","埃及"],
    "🇸🇻": ["The Salvador","Salvador","SV","萨尔瓦多"],
    "🇬🇶": ["Equatorial Guinea","GQ","赤道几内亚"],
    "🇪🇷": ["Eritrea","ER","厄立特里亚"],
    "🇪🇪": ["Estonia","EE","爱沙尼亚"],
    "🇸🇿": ["Eswatini","Swaziland","Kingdom of Eswatini","SZ","斯威士兰","斯威士兰王国","史瓦帝尼"],
    "🇪🇹": ["Ethiopia","ET","埃塞俄比亚"],
    "🇫🇰": ["Falkland Islands","Islas Malvinas","FK","福克兰群岛","马尔维纳斯群岛"],
    ...
    "🇹🇫": ["French Southern and Antarctic Lands","TF","TAAF","法属南部和南极领地","法属南部领地"],
    "🇬🇦": ["Gabon","GA","加蓬"],
    "🇬🇲": ["Gambia","GM","冈比亚"],
    "🇬🇪": ["Georgia","GE","格鲁吉亚"],
    "🇩🇪": ["Germany","Deutschland","DEU","德国","法兰克福","京德","滬德","廣德","沪德","广德"],
    "🇬🇭": ["Ghana","GH","加纳"],
    "🇬🇮": ["Gibraltar","GI","直布罗陀"],
    "🇬🇷": ["Greece","GR","希腊"],
    ...
    "🇮🇷": ["Iran","IR","伊朗"],
    "🇮🇶": ["Iraq","IQ","伊拉克"],
    "🇮🇪": ["Ireland","IE","爱尔兰","愛爾蘭", "都柏林"],
    "🇮🇲": ["Isle of Man","IM","马恩岛","曼岛"],
    "🇮🇱": ["Israel","IL","以色列"],
    "🇮🇹": ["Italy","IT","意大利"],
    "🇯🇲": ["Jamaica","JM","牙买加"],
    "🇯🇵": ["Japan","JP","JAPAN", "日本", "东京", "大阪", "埼玉", "沪日", "穗日", "川日", "中日", "泉日", "杭日", "深日", "辽日", "广日"],
    "🇯🇪": ["Jersey","JE","泽西","泽西岛"],
    "🇯🇴": ["Jordan","JO","约旦"],
    "🇰🇿": ["Kazakhstan","KZ","哈萨克斯坦"],
    "🇰🇪": ["Kenya","KE","肯尼亚"],
    "🇰🇮": ["Kiribati","KI","基里巴斯"],
    "🇰🇵": ["North Korea","KP","朝鲜","北韩"],
    "🇰🇷": ["South Korea","Korea","KR","KOR","韩国","南韩","首尔","春川"],
    "🇽🇰": ["Kosovo","XK","科索沃"],
    "🇰🇼": ["Kuwait","KW","科威特"],
    "🇰🇬": ["Kyrgyzstan","KG","吉尔吉斯斯坦","吉尔吉斯"],
    "🇱🇦": ["Laos","LA","老挝","寮国"],
    "🇱🇻": ["Latvia","LV","拉脱维亚"],
    "🇱🇧": ["Lebanon","LB","黎巴嫩"],
    "🇱🇸": ["Lesotho","LS","莱索托"],
    ...
    "🇱🇹": ["Lithuania","LT","立陶宛"],
    "🇱🇺": ["Luxembourg","LU","卢森堡"],
    "🇲🇴": ["Macao","Macau", "MO", "MAC", "澳门", "澳門", "CTM"],
    "🇲🇬": ["Madagascar","MG","马达加斯加"],
    "🇲🇼": ["Malawi","MW","马拉维"],
    "🇲🇾": ["Malaysia","MALAYSIA","MY","马来西亚","大马", "大馬", "馬來西亞", "吉隆坡"],
    "🇲🇻": ["Maldives","MV","马尔代夫"],
    "🇲🇱": ["Mali","ML","马里"],
    "🇲🇹": ["Malta","MT","马耳他"],
    ...
    "🇾🇹": ["Mayotte","YT","马约特"],
    "🇲🇽": ["Mexico","MX","墨西哥"],
    "🇫🇲": ["Micronesia","FM","密克罗尼西亚","密克罗尼西亚联邦"],
    "🇲🇩": ["Moldova","MD","摩尔多瓦"],
    "🇲🇨": ["Monaco","MC","摩纳哥"],
    "🇲🇳": ["Mongolia","MN","蒙古","蒙古国"],
    "🇲🇪": ["Montenegro","ME","蒙特内哥罗","黑山","黑山共和国"],
    "🇲🇸": ["Montserrat","MS","蒙特塞拉特"],
    "🇲🇦": ["Morocco","MA","摩洛哥"],
    "🇲🇿": ["Mozambique","MZ","莫桑比克"],
    "🇲🇲": ["Myanmar","MM","缅甸"],
    ...
    "🇳🇷": ["Nauru","NR","瑙鲁"],
    "🇳🇵": ["Nepal","NP","尼泊尔"],
    "🇳🇱": ["Netherlands","Holland","NL","荷兰","荷蘭", "尼德蘭", "阿姆斯特丹"],
    "🇳🇨": ["New Caledonia","Nouvelle-Calédonie","NC","新喀里多尼亚"],
    "🇳🇿": ["New Zealand","NZ","新西兰"],
    "🇳🇮": ["Nicaragua","NI","尼加拉瓜"],
    "🇳🇪": ["Niger","NE","尼日尔"],
    "🇳🇬": ["Nigeria","NG","尼日利亚"],
    "🇳🇺": ["Niue","NU","纽埃"],
    "🇳🇫": ["Norfolk Island","NF","诺福克群岛"],
    "🇲🇰": ["North Macedonia","MK","北马其顿","马其顿"],
    "🇲🇵": ["Northern Mariana Islands","MP","北马里亚纳","北马里亚纳群岛"],
    "🇳🇴": ["Norway","NO","挪威"],
    "🇴🇲": ["Oman","OM","阿曼"],
    "🇵🇰": ["Pakistan","PK","巴基斯坦"],
    "🇵🇼": ["Palau","PW","帕劳"],
    ...
    "🇶🇦": ["Qatar","QA","卡塔尔"],
    "🇷🇪": ["Réunion","Reunion","RE","留尼汪","法属留尼汪"],
    "🇷🇴": ["Romania","RO","罗马尼亚"],
    "🇷🇺": ["Russia","RU","俄罗斯", "毛子", "俄国", "俄羅斯", "伯力", "莫斯科", "圣彼得堡", "西伯利亚", "新西伯利亚", "京俄", "杭俄","廣俄","滬俄","广俄","沪俄"],
    "🇷🇼": ["Rwanda","RW","卢旺达"],
    "🇧🇱": ["Saint Barthélemy","Saint Barth","Saint-Barthélemy","BL","圣巴特","圣巴泰勒米"],
    "🇸🇭": ["Saint Helena, Ascension and Tristan da Cunha","SH","圣赫勒拿、阿森松和特里斯坦-达库尼亚"],
    "🇰🇳": ["Saint Kitts and Nevis","KN","圣基茨和尼维斯"],
    "🇱🇨": ["Saint Lucia","LC","圣卢西亚"],
    "🇲🇫": ["Saint Martin","MF","法属圣马丁"],
    "🇵🇲": ["Saint Pierre and Miquelon","PM","圣皮埃尔和密克隆群岛","圣皮埃尔和密克隆","圣皮埃尔"],
    "🇻🇨": ["Saint Vincent and the Grenadines","VC","圣文森特和格林纳丁斯","圣文森特"],
    "🇼🇸": ["Samoa","WS","萨摩亚"],
    "🇸🇲": ["San Marino","SM","圣马力诺"],
    "🇸🇹": ["São Tomé and Príncipe","ST","圣多美和普林西比","圣普"],
    "🇸🇳": ["Senegal","SN","塞内加尔"],
    "🇷🇸": ["Serbia","RS","塞尔维亚"],
    "🇸🇨": ["Seychelles","SC","塞舌尔"],
    "🇸🇱": ["Sierra Leone","SL","塞拉利昂"],
    "🇸🇬": ["Singapore","SG","SGP","新加坡","狮城", "沪新", "京新", "泉新", "穗新", "深新", "杭新", "广新","廣新","滬新"],
    "🇬🇵": ["Guadeloupe","GP","GLP","瓜德罗普"],
    "🇸🇽": ["Sint Maarten","SX","荷属圣马丁"],
    "🇸🇰": ["Slovakia","SK","斯洛伐克"],
    "🇸🇮": ["Slovenia","SI","斯洛文尼亚"],
    "🇸🇧": ["Solomon Islands","SB","所罗门群岛"],
    "🇸🇴": ["Somalia","SO","索马里"],
    "🇿🇦": ["South Africa","ZA","南非"],
    "🇬🇸": ["South Georgia","GS","SGSSI","南乔治亚"],
    "🇸🇸": ["South Sudan","SS","南苏丹"],
    "🇪🇸": ["Spain","ES","西班牙"],
    "🇱🇰": ["Sri Lanka","LK","斯里兰卡"],
    "🇸🇩": ["Sudan","SD","苏丹"],
    "🇸🇷": ["Suriname","SR","苏里南"],
    "🇸🇯": ["Svalbard and Jan Mayen","SJ","斯瓦尔巴和扬马延"],
    "🇸🇪": ["Sweden","SE","瑞典"],
    "🇨🇭": ["Switzerland","CH","瑞士","苏黎世"],
    "🇸🇾": ["Syria","SY","叙利亚"],
    "🇹🇼": ["Taiwan","TW","台湾","TAIWAN","台北", "台中", "新北", "彰化", "CHT", "台", "HINET"],
    "🇹🇯": ["Tajikistan","TJ","塔吉克斯坦","塔吉克"],
    "🇹🇿": ["Tanzania","TZ","坦桑尼亚"],
    "🇹🇭": ["Thailand","TH","泰国"],
    "🇹🇱": ["Timor-Leste","TL","东帝汶"],
    "🇹🇬": ["Togo","TG","多哥"],
    ...
    "🇹🇳": ["Tunisia","TN","突尼斯"],
    "🇹🇷": ["Turkey","TR","TUR","土耳其"],
    "🇹🇲": ["Turkmenistan","TM","土库曼斯坦","土库曼"],
    "🇹🇨": ["Turks and Caicos Islands","TC","特克斯和凯科斯群岛"],
    "🇹🇻": ["Tuvalu","TV","图瓦卢"],
    "🇺🇬": ["Uganda","UG","乌干达"],
    "🇺🇦": ["Ukraine","UA","乌克兰"],
    "🇦🇪": ["United Arab Emirates","AE","阿拉伯联合酋长国","阿联酋","迪拜","阿布扎比"],
    "🇬🇧": ["United Kingdom","GB","UK","英国","伦敦"],
    "🇺🇸": ["United States","US","USA","美国","京美", "波特兰", "达拉斯", "俄勒冈", "凤凰城", "费利蒙", "硅谷", "矽谷", "拉斯维加斯", "洛杉矶", "圣何塞", "圣克拉拉", "西雅图", "芝加哥", "沪美", "哥伦布", "纽约"],
    "🇸🇦": ["Saudi Arabia","SA","SAU","沙特阿拉伯","沙特"],
    "🇺🇲": ["United States Minor Outlying Islands","UM","美国本土外小岛屿"],
    "🇺🇾": ["Uruguay","UY","乌拉圭"],
    "🇺🇿": ["Uzbekistan","UZ","乌兹别克斯坦","乌兹别克"],
    "🇻🇺": ["Vanuatu","VU","瓦努阿图"],
    "🇻🇦": ["Vatican City","Holy See","梵蒂冈","梵蒂冈城","圣座"],
    "🇻🇪": ["Venezuela","VE","委内瑞拉"],
    "🇻🇳": ["Vietnam","VN","越南"],
    "🇻🇬": ["British Virgin Islands","VG","英属维尔京群岛","英属维尔京"],
    "🇻🇮": ["United States Virgin Islands","VI","美属维尔京群岛","美属维尔京"],
    "🇼🇫": ["Wallis and Futuna","WF","瓦利斯和富图纳群岛","瓦利斯和富图纳"],
